...
<div class="container">
    <div class="col-sm-12 col-md-8 col-lg-8" style="color:#555;">
        <h2>
            <?php echo $chi_tiet_sk->tieu_de; ?>
        </h2>

        <p style="font-size: 18px; padding: 10px 0;">
            <?php echo $chi_tiet_sk->mo_ta_tom_tat; ?>
        </p>

        <img src="images/su-kien/hinh-bai-viet/<?php echo $chi_tiet_sk->hinh_trang_chu; ?>" class="img-responsive" alt="Image" style="margin: 0 auto; padding: 10px 0;">

        <p style="font-size: 18px; padding: 10px 0;">
            <?php echo $chi_tiet_sk->mo_ta_chi_tiet; ?>
        </p>
                    ...
                    <div class="binh_luan_lien_quan" style="margin-top: 20px; ">
                        <ul>
                            <?php 
                                ...
                                ?>
                            <li>
                                <a href="index.php?task=ctsk&id_bl=<?php echo $su_kien->id; ?>">
                                    <div class="wrap-hinh-km">
                                        <img src="images/su-kien/<?php echo $su_kien->hinh_bai_viet;?>" class="img-responsive hinh-anh-km">
