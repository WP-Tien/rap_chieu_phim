...
include_once("model/model_loai_phim.php");
	...
	class c_list_phim_sap_chieu 
	{
		...
		function hien_tri_list_phim_sap_chieu()
		{
			...
			{
				$ds_phim_sap_chieu_theo_loai = $this->model_phim->ds_phim_sap_chieu_theo_loai($_POST["id_loai_phim"]);	
			}
			else
			{
				$ds_phim_sap_chieu = $this->model_phim->danh_sach_phim_sap_chieu(); 
			}
			
			//print_r($ds_phim_sap_chieu);

			include_once("view/list_phim_sap_chieu.php");
		}
